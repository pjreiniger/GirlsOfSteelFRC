...
public class HangerSubsystem extends SubsystemBase {
    ...
    public HangerSubsystem() {
        ...
        m_leftHanger.configure(leftHangerConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_rightHanger.configure(rightHangerConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
