...
public class VerticalConveyorSubsystem extends SubsystemBase {
    ...
    public VerticalConveyorSubsystem() {
        ...
        m_conveyor.configure(conveyorConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_feeder.configure(feederConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
