...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public DrivetrainSubsystem() {
        ...
        m_leftProperties = setupVelocityPidValues(m_leftLeader);
        m_rightProperties = setupVelocityPidValues(m_rightLeader);
        ...
        m_leftLeader.configure(leftLeaderConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_leftFollower.configure(leftFollowerConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_rightLeader.configure(rightLeaderConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_rightFollower.configure(rightFollowerConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
    ...
    private PidProperty setupVelocityPidValues(SparkMax motor) {
        return new RevPidPropertyBuilder("ChassisVelocity", false, motor, ClosedLoopSlot.kSlot0)
            .addP(1)
            .addI(0)
            .addD(0)
            .build();
