...
public class ShooterSubsytem extends SubsystemBase {
    ...
    public ShooterSubsytem() {
        ...
        m_pidProperties = new RevPidPropertyBuilder("Shooter", false, m_shooterMotor, ClosedLoopSlot.kSlot0)
            .addP(0)
            .addI(0)
            .addD(0)
            .addFF(0.00045)
        ...
        m_shooterMotor.configure(shooterMotorConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
