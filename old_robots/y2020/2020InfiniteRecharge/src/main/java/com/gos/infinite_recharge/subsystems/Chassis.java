...
public class Chassis extends SubsystemBase {
    ...
    public Chassis() {
        ...
        m_leftProperties = new RevPidPropertyBuilder("Chassis", lockConstants, m_masterLeft, ClosedLoopSlot.kSlot0)
            .addP(kp)
            .addI(ki)
            .addD(kd)
            .addFF(kff)
            ...
            .build();
        m_rightProperties = new RevPidPropertyBuilder("Chassis", lockConstants, m_masterRight, ClosedLoopSlot.kSlot0)
            .addP(kp)
            .addI(ki)
            .addD(kd)
            .addFF(kff)
        ...
        m_masterLeft.configure(masterLeftConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_followerLeft.configure(followerLeftConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_masterRight.configure(masterRightConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
