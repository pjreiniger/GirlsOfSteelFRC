...
public class Winch extends SubsystemBase {
    ...
    public Winch(boolean isBrushed) {
        ...
        m_motorA.configure(motorAConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        m_motorB.configure(motorBConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
