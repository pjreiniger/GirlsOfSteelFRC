...
public class HangerSubsystem extends SubsystemBase {
    ...
    public HangerSubsystem() {
        ...
        m_leftPidProperties = createPidProperties(m_leftHangerMotor);
        m_leftHangerMotor.configure(leftHangerMotorConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        ...
        m_rightPidProperties = createPidProperties(m_rightHangerMotor);
        m_rightHangerMotor.configure(rightHangerMotorConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
    ...
    private PidProperty createPidProperties(SparkMax motor) {
        return new RevPidPropertyBuilder("HangerPid", false, motor, ClosedLoopConfig.ClosedLoopSlot.kSlot0)
            .addP(0.1)
            .build();
    }
