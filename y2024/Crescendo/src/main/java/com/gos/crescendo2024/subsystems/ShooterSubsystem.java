...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        m_pidProperties = new RevPidPropertyBuilder("Shooter", Constants.DEFAULT_CONSTANT_PROPERTIES, m_shooterMotorLeader, ClosedLoopConfig.ClosedLoopSlot.kSlot0)
            .addP(1.5e-4)
            .addI(0.0)
            .addD(0.0)
            .addFF(0.000185)
        ...
        m_shooterMotorLeader.configure(shooterMotorLeaderConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        ...
        m_shooterMotorFollower.configure(shooterMotorFollowerConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
        ...
        if (RobotBase.isSimulation()) {
            ...
            this.m_shooterSimulator = new FlywheelSimWrapper(shooterFlywheelSim, new RevMotorControllerSimWrapper(this.m_shooterMotorLeader, gearbox), RevEncoderSimWrapper.create(this.m_shooterMotorLeader));
        }
    ...
    public void setPidRpm(double rpm) {
        this.m_pidController.setReference(rpm, SparkBase.ControlType.kVelocity);
