...
package com.gos.mepi.rapid_react;
...
import com.gos.mepi.rapid_react.commands.ClimberCommand;
import com.gos.mepi.rapid_react.commands.ExampleCommand;
import com.gos.mepi.rapid_react.subsystems.ClimberSubsystem;
import com.gos.mepi.rapid_react.subsystems.ExampleSubsystem;
import com.gos.mepi.rapid_react.subsystems.IntakeSubsystem;
import com.gos.mepi.rapid_react.commands.ToggleIntakeCommand;
import com.gos.mepi.rapid_react.commands.RunIntakeCommand;
import com.gos.mepi.rapid_react.commands.TowerDownCommand;
import com.gos.mepi.rapid_react.commands.TowerUpCommand;
import com.gos.mepi.rapid_react.commands.TowerKickerCommand;
import com.gos.mepi.rapid_react.ShooterLookupTable;
import com.gos.mepi.rapid_react.commands.ShooterPIDCommand;
import com.gos.mepi.rapid_react.subsystems.TowerSubsystem;
import com.gos.mepi.rapid_react.subsystems.ShooterSubsytem;
import com.gos.mepi.rapid_react.subsystems.HopperSubsystem;
import com.gos.mepi.rapid_react.subsystems.IntakeSubsystem;
import com.gos.mepi.rapid_react.subsystems.LimelightSubsystem;
import com.gos.mepi.rapid_react.subsystems.DrivetrainSubsystem;
import com.gos.mepi.rapid_react.commands.DriveCommand;
import com.gos.mepi.rapid_react.commands.KickIfShootSetRPMCommand;
import com.gos.mepi.rapid_react.commands.KickIfShooterDistanceGoBrrCommand;
import com.gos.mepi.rapid_react.commands.HopperCommand;
import com.gos.mepi.rapid_react.commands.ToggleIntakeCommand;
import com.gos.mepi.rapid_react.commands.AutoAimCommand;
import edu.wpi.first.wpilibj2.command.button.Button;
import com.gos.mepi.rapid_react.commands.SetShooterSpeedCommand;
